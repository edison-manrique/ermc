 ...
 *
 * demo/06_engine.ts — OmniEngine: Descubrimiento Simbólico de Leyes Físicas
 */
import { OmniEngine, Activation } from "../src/index";

console.log("=".repeat(60));
console.log("  ERMC | Demo 06: OmniEngine - Descubrimiento de Leyes Físicas");
console.log("=".repeat(60));
