 ...
 *
 * demo/04_sequence.ts — IA de Sucesiones Matemáticas
 */
import { SequenceAI } from "../src/index";

console.log("=".repeat(60));
console.log("  ERMC | Demo 04: IA de Sucesiones Matemáticas");
console.log("=".repeat(60));
...
console.log(`  Predicción ERMC: ${predM.toFixed(1)}`);
