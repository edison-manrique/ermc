 ...
 *
 * demo/11_series.ts — Mock Theta de Ramanujan & Distribución de Primos (WASM)
 * Descubre: Convergencia de Watson, π(x) exacto vs Li(x), Hipótesis de Riemann
 */

import { loadErmc, getSeries } from "../src/index";
...
console.log("\n╔══════════════════════════════════════════════════════════╗");
console.log("║  ERMC WASM | Demo 11: Ramanujan Mock Theta & Primos      ║");
console.log("╚══════════════════════════════════════════════════════════╝\n");
...
console.log("\n✓ Demo 11 completada — Ramanujan & Distribución de Primos (WASM)\n");
