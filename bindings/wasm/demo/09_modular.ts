 ...
 *
 * demo/09_modular.ts — Aritmética Modular en F_p (WASM)
 * Descubre: Pequeño Teorema de Fermat, residuos cuadráticos y raíces mod p
 */

import { loadErmc, getModular } from "../src/index";
...
console.log("\n╔══════════════════════════════════════════════════════╗");
console.log("║  ERMC WASM | Demo 09: Aritmética Modular en F_p     ║");
console.log("╚══════════════════════════════════════════════════════╝\n");
...
console.log("\n✓ Demo 09 completada — Aritmética Modular F_p (WASM)\n");
