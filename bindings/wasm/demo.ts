...
console.log("=========================================================================");
console.log("  ERMC EN BUN + TYPESCRIPT VIA WEBASSEMBLY (WASM)");
console.log(`  Versión WASM (Zig 0.16): ${getVersion()}`);
console.log("=========================================================================\n");
...
console.log(`  Suma Neumaier WASM (exacta): ${neumaierSum}\n`);
...
console.log(`  Términos en Diccionario: ${engine.getTermCount()} | Tiempo en WASM: ${(t1 - t0).toFixed(2)} ms`);
...
console.log("=========================================================================");
console.log(" >> Bun + TypeScript WASM sobre ermc.wasm FUNCIONANDO AL 100%!");
console.log("=========================================================================");
